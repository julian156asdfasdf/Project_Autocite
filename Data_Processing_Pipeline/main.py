...
if __name__ == '__main__':
    ...
    step_0_target_name = os.path.join("Data_Processing_Pipeline","Step_0")
    step_1_target_name = os.path.join("Data_Processing_Pipeline","Step_1")
    step_2_target_name = os.path.join("Data_Processing_Pipeline","Step_2")
    step_3_target_name = "dataset.pkl"
    # Remember to update the start_idx, window_size and end_idx to the desired values
    step_0 = step0_processing(target_name=step_0_target_name, start_idx=0, window_size=100, end_idx=1000)
    ...
    # Step 1 Extract from .tar and remove irrelevant files
        ...
        step_1.rmv_irrelevant_files(manifest_title=os.path.join("Data_Processing_Pipeline","Manifests","manifest_irrelevant_files.txt"))
